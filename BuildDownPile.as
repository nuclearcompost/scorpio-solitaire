package
{
	...
	//	
	//-----------------------
	public class BuildDownPile extends CardStack
	{
		// Constants //
		...
		public function BuildDownPile(parent:GameController, suit:int)
		{
			_parent = parent;
			_suit = suit;
		}
		...
		public override function Paint():MovieClip
		{
			...
			else
			{
				...
				_container.removeEventListener(MouseEvent.CLICK, OnBuildDownPileClick);
			}
			
			return _container;
		}
		
		public function BuildDownPileClick():void
		{
			_parent.OnBuildDownPileClick(this);
		}
